...
print "\n-> To cover a floor of ",width_of_floor,"*",length_of_floor,"m, using tiles of ",width_of_tile,"*",length_of_tile,"m, that cost ",cost_of_tile,"euros per piece,\n it will cost you ",total_cost_of_tiles,"euros and you will need ",nbr_of_tiles,"tiles. You're welcome."
