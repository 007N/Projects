...
intrest_rate = float(raw_input("Please enter your intrest rate per month in percent. >> ")) #This is in percent multiply it by 100.
payed_by_month = float(raw_input("Please enter how much you want to pay per month. >> ")) #In Euros
month_needed = 0
total_payed = 0
import time
